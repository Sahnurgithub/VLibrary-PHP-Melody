			...
			<div class="col-10 help-panel-content">
				<div class="tab-content" id="v-pills-tabContent">
					<div class="tab-pane show active" id="v-pills-one" role="tabpanel" aria-labelledby="v-pills-tab-help-one">
						...
						<p><strong>Note</strong>: This feature was introduced in version 2.6 (February, 2016). If you'd like to see more automated jobs added to your PHP Melody site please <a href="http://blankrefer.com/?http://www.phpmelody.com/feedback-features" target="_blank">suggest them here</a>.</p>
					</div>
