			...
			<div class="col-10 help-panel-content">
				<div class="tab-content" id="v-pills-tabContent">
					...
					<div class="tab-pane" id="v-pills-two" role="tabpanel" aria-labelledby="v-pills-tab-help-two">
						...
						<p>For more details on how to include your own ad zones into the template files, please visit <a href="http://blankrefer.com/?http://help.phpmelody.com/how-to-add-banners-manually/" target="_blank">http: //help.phpmelody.com/how-to-add-banners-manually/
</a></p>
					</div>
				</div>
			</div>
