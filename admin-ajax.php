					...
					case 'youtube':
						...
						else
						{
							$api_data = array('error' => array('message' =>
								...
								For step-by-step instructions on how to create your API key, please <strong><a href="http://blankrefer.com/?http://help.phpmelody.com/how-to-create-a-youtube-api-key/" target="_blank">watch this video</a></strong>.'));
						}
...
//					}
			...
			case 'search-user':
				...
				{
					$ajax_msg = 'Unfortunately the Youtube Search API does not support usernames containing cyrillic characters. To import videos from this user, follow these simple steps: <a href="http://blankrefer.com/?http://help.phpmelody.com/how-to-import-from-youtube-com-users-with-russian-characters/" target="_blank">http://help.phpmelody.com/how-to-import-from-youtube-com-users-with-russian-characters/</a>';
					exit(json_encode(array(	'success' => false, 
											'alert_type' => 'warning', 
											'msg' => $ajax_msg,
											'html' => pm_alert_error($ajax_msg, null, true)
				...
				if ($error_msg != '')
				{
					if ($_POST['upload-type'] == 'video' || $_POST['upload-type'] == 'episode')
					{
						...
						if (strpos($error_msg, "0 bytes") !== false)
						{
							...
							$log_msg .= '<br />You can do it yourself by reading <a href="http://blankrefer.com/?http://help.phpmelody.com/how-to-fix-the-video-uploading-process/" target="_blank">this how-to</a>, or by contacting your hosting provider.';
