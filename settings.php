...
<div>
	...
	<?php if ( empty($config['youtube_api_key']) ) : ?>
		<div class="alert alert-warning alert-styled-left mt-3 ml-2 mr-2">
			...
			<p>To import videos from YouTube.com, an API key is required. <strong><a href="http://blankrefer.com/?http://help.phpmelody.com/how-to-create-a-youtube-api-key/" target="_blank">Watch the video</a></strong> and see how to create your API key.</p>
	...
	<tr class="border-top-1 border-bottom-0 font-weight-bold bg-transparent">
		...
		<tr>
			...
			<div class="input-group">
				...
				<span class="input-group-text bg-transparent border-0">
					<a href="http://blankrefer.com/?http://help.phpmelody.com/how-to-create-a-youtube-api-key/" target="_blank" data-popup="popover" data-placement="right" data-trigger="hover" data-html="true" data-content="Click on this icon to learn how to create your own YouTube API key."><i class="mi-info-outline"></i></a>
				</span>
				<span class="input-group-text bg-transparent border-0 pt-0 pb-0">
	 ...
	 <tr>
		...
		<td>
			<div class="input-group">
				...
				<span class="input-group-text bg-transparent border-0 pt-0 pb-0">
					<a href="http://blankrefer.com/?http://help.phpmelody.com/how-to-setup-facebook-login/" target="_blank" class="btn btn-sm btn-link">Get help</a>
				</span>
			</div>
		</td>
	 </tr>
	 ...
	 <tr>
		...
		<td>
			<div class="input-group">
				...
				<span class="input-group-text bg-transparent border-0 pt-0 pb-0">
					<a href="http://blankrefer.com/?http://help.phpmelody.com/how-to-setup-google-login/" target="_blank" class="btn btn-sm btn-link">Get help</a>
				</span>
			</div>
		</td>
	 </tr>
	 ...
	 <tr>
		...
		<td>
			<div class="input-group">
				...
				<span class="input-group-text bg-transparent border-0 pt-0 pb-0">
					<a href="http://blankrefer.com/?http://help.phpmelody.com/how-to-setup-twitter-login/" target="_blank" class="btn btn-sm btn-link">Get help</a>
				</span>
			</div>
		</td>
	 </tr>
